    ...
    <Container maxW={"8xl"} py={12} px={{
      ...
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing={10}>
        <Stack spacing={4}>
          ...
          <Heading>nonumy eirmod tempor invidunt ut labore</Heading>
          <Text color={"gray.500"} fontSize={"lg"}>
            Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
            nonumy eirmod tempor invidunt ut labore. Lorem ipsum dolor, sit amet
            consectetur adipisicing elit. Reiciendis nemo illum omnis deleniti
            mollitia facere fugiat soluta ex, voluptatem velit!
          </Text>
          <Stack
            spacing={4}
            divider={
